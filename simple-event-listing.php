...
define( 'SEL_ROOT', dirname( plugin_basename( SEL_FILE ) ) );
...
if ( requirements_are_met() ) {
    ...
    if ( class_exists( 'EventsController' ) ) {
        ...
        register_activation_hook( SEL_FILE, array( $sel, 'activate' ) );
		register_deactivation_hook( SEL_FILE, array( $sel, 'deactivate' ) );
    }
} else {
