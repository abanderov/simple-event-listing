    ...
    class Events_Controller {
        ...
        public static function save_location_meta_box_data( $post_id ) {
            ...
            $location_data = array(
                ...
                'sel_latitude' => ! empty( $_POST['sel_location']) ? sanitize_text_field( $_POST['sel_latitude'] ) : '',
                'sel_longitude' => ! empty( $_POST['sel_location']) ? sanitize_text_field( $_POST['sel_longitude'] ) : '',
            );
